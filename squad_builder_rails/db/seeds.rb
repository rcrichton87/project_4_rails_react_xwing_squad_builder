...
pilot3 = Pilot.create({name: "Wes Jansen", cost: 8, pilot_skill: 8, ability: "After attacking, you may remove a focus, evade, or blue target lock token from the defender", ship_id: ship1[:id]})
